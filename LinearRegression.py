...
data = pd.read_csv("Dataset/DatasetV2/XTZ.csv")
...
Linearegressor.fit(X_train, y_train)



#score = Linearegressor.score(X_test, y_test)
#print(score)


y_pred = Linearegressor.predict(X_test)
...
print("\t\tError Table for Linear Regression Algorithm - Ethereum Data")
...
plt.legend()
plt.title("Linear Regression Algorithm - Actual vs. Predicted Graph for Ethereum Data")
plt.show()